...
public interface StayDeleteInterface {
    ...
    Map<String, Long> getDocumentCountFromCache(@PathVariable("environment") String env);
    ...
    @GetMapping("/allDocumentCounts/environment/{environment}")
    ...
    @PostMapping("/check/PostgressNotSynced/{environment}")
    Map<String, Long> checkPostgressNotSynced(@PathVariable("environment") String env);
